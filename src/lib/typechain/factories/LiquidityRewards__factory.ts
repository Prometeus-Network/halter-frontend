...
const _abi = [
  ...
  },
  {
    ...
    name: "finalDirtyRewardsRegister",
    outputs: [
      {
        internalType: "uint256",
        name: "amount",
  ...
  },
  {
    ...
    name: "finalFalseRewardsRegister",
    outputs: [
      {
        internalType: "uint256",
        name: "amount",
  ...
  },
  {
    ...
    name: "getClaimableVestedRewardsForSpecificPool",
    outputs: [
      {
        internalType: "uint256",
        name: "reward",
  ...
  {
    inputs: [],
    name: "getTotalClaimableVestedRewards",
    outputs: [
      {
        internalType: "uint256",
        name: "reward",
  ...
  {
    inputs: [],
    name: "getTotalRewardsAfterVestingForAllPools",
    outputs: [
      {
        internalType: "uint256",
        name: "totalReward",
